...
02. Clone the repository:
    ...
    ```console
    git clone -b own-config --recursive https://github.com/botenbreuk/prezto.git "${ZDOTDIR:-$HOME}/.zprezto"
    ```
    ...
    <details>
      ...
      - Clone the repository:
        ...
        ```console
        git clone -b own-config --recursive https://github.com/botenbreuk/prezto.git "${ZDOTDIR:-${XDG_CONFIG_HOME:-$HOME/.config}/zsh}/.zprezto"
        ```
